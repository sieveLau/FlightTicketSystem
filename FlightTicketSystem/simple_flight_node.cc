...
ds::SimpleFlightNode::SimpleFlightNode(ds::SimpleFlight* data,
                                       SimpleFlightNode* next_node) {
    data_      = data;
...
ds::SimpleFlightNode& ds::SimpleFlightNode::operator=(
    SimpleFlightNode another) {
    Swap(another);
    return *this;
}
ds::SimpleFlightNode::~SimpleFlightNode() { Reset(); }
